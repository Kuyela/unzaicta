	...
	<div class="card col-lg-12">
		<div class="card-body">
			<form action="" id="manage-settings">
				...
				<div class="form-group">
					<label for="" class="control-label">Association Logo</label>
