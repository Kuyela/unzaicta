            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=Listing of Executive by Name and Position">EXECUTIVE</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=about unzaicta">ABOUT UNZAICTA</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=milestones">MILESTONES</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=short_courses">SHORT COURSES</a></li>
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2022 - <?php echo $_SESSION['system']['name'] ?> | <a href="https://web.facebook.com/Unzaicta-298762537724408/" target="_blank">FACEBOOK PAGE</a></div></div>
        </footer>
